...
\only<1>{\includegraphics[height=.425\textheight]{figs/gsbp_tri1.png}}
\only<2>{\includegraphics[height=.425\textheight]{figs/gsbp_tri2.png}}
\only<3>{\includegraphics[height=.425\textheight]{figs/gsbp_tri3.png}}
\only<4>{\includegraphics[height=.425\textheight]{figs/gsbp_tri4.png}}
\end{overlayarea}
\end{figure}
\end{column}
\hspace{2.5em}
