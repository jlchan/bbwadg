...
\date[June 9-15, 2018]{ECCM-CFD 2018\\June 9-15, 2018}
...
%\hspace{1em}
\subfloat[$\int_{\Omega}U(\bm{u})$ for entropy cons.\ scheme]{
\begin{tikzpicture}
\begin{loglogaxis}[
        scaled ticks=false, 
        tick label style={/pgf/number format/fixed},
