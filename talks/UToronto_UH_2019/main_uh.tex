...
\date[1/16/20]{University of Houston, Houston, TX\\January 16, 2020}
...
\subfloat[Philip Wu (PhD, shallow water + GPU)]{\includegraphics[height=.32\textheight]{pw.png}\hspace{.5em}\includegraphics[height=.32\textheight]{Dam3.png}}
\end{figure}
}
...
\hspace{1em}
\raisebox{.15em}{\includegraphics[width=.29\textwidth]{figs/dg.pdf}}\\
\subfloat[High order FEM]{\includegraphics[width=.29\textwidth]{figs/MCG.pdf}}
\hspace{1em}
\subfloat[High order DG]{{\includegraphics[width=.29\textwidth]{figs/MDG.pdf}}}
...
%\hspace{1em}
\raisebox{.0em}{\includegraphics[width=\textwidth]{figs/balancing.pdf}}
