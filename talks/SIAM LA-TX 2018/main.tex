...
\date[October 6-7, 2018]{SIAM LA-TX Sectional conference}
...
\vspace{-.5em}
\begin{itemize}
\item Observed $L^2$ error is $O(h^{N+1})$; can prove $O(h^{N+1/2})$ convergence.
...
\begin{itemize}
\item Symmetric velocity-stress formulation (entries of $\bm{A}_i$ either $\pm 1$ or $0$)
\begin{align*}
...
%Isotropic and anisotropic media treated in the same way
}

\frame{
\frametitle{Energy stable acoustic-elastic coupling}
\vspace{-.4em}
\begin{figure}
\centering
\only<1>{
\includegraphics[width=.875\textwidth]{figs/elas_acous1.png}
}
\only<2>{
\includegraphics[width=.875\textwidth]{figs/elas_acous2.png}
}
\only<3>{
\setcounter{subfigure}{0}
\subfloat[Coupling conditions]{\raisebox{.8em}{\includegraphics[width=.45\textwidth]{figs/elas_acous1.png}}}
\subfloat[Scholte wave]{
\begin{tikzpicture}
\begin{loglogaxis}[
width=.475\textwidth,
%height=1\textwidth,
...
\addplot[color=red,mark=o] coordinates {
	(0.25,0.0106168)	(0.125, 0.001409676)	(0.0625,0.000181219)	(0.0312,0.00002318)
};
\addplot[color=blue,mark=o] coordinates {
	(0.25,0.0006848427)	(0.125, 0.0000461)	(0.0625,0.000002939)	(0.0312,0.000000183)
};
\addplot[color=red,mark=triangle] coordinates {
	(0.25,0.000034449)	(0.125, 0.000001106)	(0.0625,0.0000000346176)	(0.0312,0.00000000119144)
};
\logLogSlopeTriangle{0.2}{0.1}{0.59}{3}{red};
\logLogSlopeTriangle{0.2}{0.1}{0.34}{4}{blue};
\logLogSlopeTriangle{0.2}{0.1}{0.08}{5}{red};
\legend{$N=2$,$N=3$,$N=4$}
\end{loglogaxis}
\end{tikzpicture}
}
\vspace{1.5em}
\caption*{Straightforward penalty numerical fluxes in terms of interface residuals, energy stable and high order accurate for high order heterogeneous media.}
}
\end{figure}
...
\only<1>{
\centering
\subfloat{\includegraphics[width=.275\textwidth]{figs/nodal1D.eps}}
%\hspace{.125em}
\subfloat{\includegraphics[width=.375\textwidth]{figs/nodal2D.png}}
%\hspace{.125em}
...
\node[above,blue] at (axis cs: .0475,2e-6){\ovalbox{piecewise linear $c^2$}};
...
& $N=3$ & $N=4$ & $N=5$ & $N=6$ & $N=7$ & \textcolor{red}{$N=8$} \\
   \hline
WADG  &    1.65e-8  &  3.35e-8 &   6.94e-8 &  1.31e-7 &  3.28e-7  &  \textcolor{red}{2.89e-6}\\
  \hline
BBWADG &   1.81e-8 &  2.59e-8 &   4.22e-8 &   6.16e-8 &  9.79e-8 & 1.32e-7 \\
  \hline
Speedup &    0.9116 &    1.2934 &    1.6445 &    2.1266 &    3.3504 &   \textcolor{red}{21.8939}\\
  \hline
\end{tabular}  
\vspace{.5em} 
...
\vspace{.5em}
\begin{itemize}
\item Weight-adjusted DG: provable stability, high order accuracy, and efficiency in heterogeneous acoustic and elastic media.
\vspace{.5em}
...
\let\thefootnote\relax\footnotetext{\tiny Guo, Chan (2018).  {Bernstein-B\'ezier weight-adjusted DG methods for wave propagation in heterogeneous media}.}
