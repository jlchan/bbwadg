...
global fxSv1 fySv1 fxSv2 fySv2 fxSv3 fySv3
...
fxSv1 = @(hL,uL,vL,hR,uR,vR) avg(hL.*uL,hR.*uR);
fxSv2 = @(hL,uL,vL,hR,uR,vR) avg(hL.*uL,hR.*uR).*avg(uL,uR) + g*avg(hL,hR).^2 - .5*g*avg(hL.^2,hR.^2);
fxSv3 = @(hL,uL,vL,hR,uR,vR) avg(hL.*uL,hR.*uR).*avg(vL,vR);
fySv1 = @(hL,uL,vL,hR,uR,vR) avg(hL.*vL,hR.*vR);
fySv2 = @(hL,uL,vL,hR,uR,vR) avg(hL.*vL,hR.*vR).*avg(uL,uR);
fySv3 = @(hL,uL,vL,hR,uR,vR) avg(hL.*vL,hR.*vR).*avg(vL,vR) + g*avg(hL,hR).^2 - .5*g*avg(hL.^2,hR.^2);

fxS1 = @(hL,uL,vL,hR,uR,vR) avg(hL.*uL,hR.*uR);
fxS2 = @(hL,uL,vL,hR,uR,vR) avg(hL.*uL,hR.*uR).*avg(uL,uR) + g*avg(hL,hR).^2 - .5*g*avg(hL.^2,hR.^2);
fxS3 = @(hL,uL,vL,hR,uR,vR) avg(hL.*uL,hR.*uR).*avg(vL,vR);
fyS1 = @(hL,uL,vL,hR,uR,vR) avg(hL.*vL,hR.*vR);
fyS2 = @(hL,uL,vL,hR,uR,vR) avg(hL.*vL,hR.*vR).*avg(uL,uR);
fyS3 = @(hL,uL,vL,hR,uR,vR) avg(hL.*vL,hR.*vR).*avg(vL,vR) + g*avg(hL,hR).^2 - .5*g*avg(hL.^2,hR.^2);
...
for e = 1:K
    ...
    FxS1 = fxSv1(hx,ux,vx,hy,uy,vy);  FyS1 = fySv1(hx,ux,vx,hy,uy,vy);      
    FxS2 = fxSv2(hx,ux,vx,hy,uy,vy);  FyS2 = fySv2(hx,ux,vx,hy,uy,vy);  
    FxS3 = fxSv3(hx,ux,vx,hy,uy,vy);  FyS3 = fySv3(hx,ux,vx,hy,uy,vy);  
