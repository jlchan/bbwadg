function [x,y,z,rx,sx,tx,ry,sy,ty,rz,sz,tz,J] = tet_geom_factors(VX,VY,VZ,r,s,t)

% get vertex nodal bases
r1 = [-1  1 -1 -1 ]'; s1 = [-1 -1  1 -1 ]'; t1 = [-1 -1 -1  1 ]';
% plot3(r1,s1,t1,'.')
% text(r1+.05,s1+.05,t1+.05,num2str((1:4)'))
% return
V1 = tet_basis(1,r1,s1,t1); 
invV = inv(V1);

[V1 Dr1 Ds1 Dt1] = tet_basis(1,r,s,t); % eval map @ cubature
