...
loglog( dxRef,4e0*dxRef.^4,'m-','lineWidth',lineWidth,'MarkerSize',ms  );
loglog( dxRef,4e0*dxRef.^6,'g-','lineWidth',lineWidth,'MarkerSize',ms  );
loglog( dxRef,4e0*dxRef.^8,'r-','lineWidth',lineWidth,'MarkerSize',ms  );
loglog( dxRef,9e0*dxRef.^10,'k-','lineWidth',lineWidth,'MarkerSize',ms  );
loglog( dxRef,3e1*dxRef.^12,'b-','lineWidth',lineWidth,'MarkerSize',ms  );
loglog( dxRef,5e1*dxRef.^14,'m-','lineWidth',lineWidth,'MarkerSize',ms  );
loglog( dxRef,9e1*dxRef.^16,'g-','lineWidth',lineWidth,'MarkerSize',ms  );
%loglog( dxRef,3e2*dxRef.^18,'r-','lineWidth',lineWidth,'MarkerSize',ms  );
%loglog( dxRef,8e2*dxRef.^20,'k-','lineWidth',lineWidth,'MarkerSize',ms  );
%loglog( dxRef,8e2*dxRef.^22,'b-','lineWidth',lineWidth,'MarkerSize',ms  );
hold off
...
if( writePlots == 1 )
  plotName = sprintf('images/wave_u_ND_ghostBasis_Lm.eps');
