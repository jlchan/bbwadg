...
%
% Output: new_n = new number of functions
%         new_Xi = new knot vector
%         new_P = new array of NURBS control points
%         new_w = new array of NURBS weights
%
% Purpose: Refine a NURBS curve
%
