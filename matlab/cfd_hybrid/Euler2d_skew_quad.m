for Ngeo = 1:6
    ...
    % [rq1D_face wq1D_face] = clenshaw_curtis(N+Ngeo-2);
    ...
    Lx = 7.5; Ly = 5; ratiox = 3/4; ratioy = 1;
    ...
    % reduce geometry order
    [rM sM] = meshgrid(JacobiGL(0,0,Ngeo)); rM = rM(:); sM = sM(:);
    F = (Vandermonde2DQuad(Ngeo,r,s)/Vandermonde2DQuad(Ngeo,rM,sM))*(Vandermonde2DQuad(N,rM,sM)/Vandermonde2DQuad(N,r,s));
    x = F*x;
    y = F*y;
