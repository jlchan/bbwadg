function [mapM, mapP] = BuildNodeMaps3D(xf,yf,zf,EToE,EToF)
...
mapM    = reshape(1:K*Nfp*Nfaces, Nfp, Nfaces, K);
mapP    = mapM;
...
for k1=1:K
    for f1=1:Nfaces
        ...
        if (k1==k2)
            ...
            x1 = xf(idM,k1); y1 = yf(idM,k1); z1 = zf(idM,k1);
            x2 = xf(idP,k2); y2 = yf(idP,k2); z2 = zf(idP,k2);          
