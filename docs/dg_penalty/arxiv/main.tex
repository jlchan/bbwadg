...
%(\bm{A}_n\bm{U})^* = \frac{1}{2}\bm{A}_n\LRp{\bm{U}^+ + \bm{U}^-} - \frac{\tau}{2} \bm{A}_n^T \bm{A}_n\LRp{\bm{U}^+ - \bm{U}^-}.
\]
...
%(\bm{A}_n\bm{U})^* = \frac{1}{2}\bm{A}_n\LRp{\bm{U}^++\bm{U}^-} - \frac{1}{2}\bm{V}\LRb{\bm{\Lambda}}\bm{V}^T \LRp{\bm{U}^+ - \bm{U}^-}.  
\]
...
\begin{figure}
\centering
\subfloat[$c_j^0$ (coefficients of a spurious mode for  $\tau = 0$)]{\includegraphics[width=.425\textwidth]{ceigs0.png}}
\hspace{1em}
\subfloat[$c_j^{100}$ (coefficients of a spurious mode for $\tau = 100$)]{\includegraphics[width=.425\textwidth]{ceigs100.png}}
...
\begin{figure}
\centering
\subfloat[$\tau = 0,1, 50$, zoomed in view]{\includegraphics[height=.275\textheight]{waveEigs2Dbox.png}\label{subfig:big}}
\hspace{3em}
\subfloat[$\tau= 0,1,50$, returning eigenvalue paths]{\includegraphics[height=.275\textheight]{trackedWaveEigs2D.png}\label{subfig:box}}
...
\begin{figure}
\centering
\subfloat{\includegraphics[width=.4275\textwidth]{trackedAdvecEigs.png}}
\hspace{2em}
\subfloat{\includegraphics[width=.42\textwidth]{trackedAdvecEigsZoom1.png}}
