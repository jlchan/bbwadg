...
\begin{figure}
\centering
\subfloat[Paths of eigenvalues as $\tau$ increases]{\includegraphics[width=.48\textwidth]{figs/trackedEigs.png}}
\hspace{1em}
\subfloat[Zoom of eigenvalues near imaginary axis]{\includegraphics[width=.435\textwidth]{figs/trackedEigsZoom.png}}
...
\begin{figure}
\centering
\subfloat[$c_j^0$ (spurious modes for  $\tau = 0$)]{\includegraphics[width=.45\textwidth]{figs/ceigs0.png}}
\hspace{1em}
\subfloat[$c_j^{100}$ (spurious modes for $\tau = 100$)]{\includegraphics[width=.45\textwidth]{figs/ceigs100.png}}
