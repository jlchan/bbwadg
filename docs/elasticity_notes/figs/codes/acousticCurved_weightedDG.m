...
% keyboard
% acousticCurved_weightedDG_driver(3,0,0);
% acousticCurved_weightedDG_driver(3,1,0);
...
function [L2err href] = acousticCurved_weightedDG_driver(Nin,nref,useJprojection)
