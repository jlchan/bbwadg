...
\begin{figure}[!h]
\centering
\subfloat[Entropy contribution $\LRb{\bm{v}_N^T \bm{V}_h^T\LRp{\bm{Q}_h \circ \bm{F}}\bm{1}}$]{\includegraphics[width=.4525\textwidth]{entropyrhs.png}}
\hspace{2em}
%\subfloat[Difference, 25 modes]{\includegraphics[width=.32\textwidth]{viscdiff25modes.png}}
\subfloat[Density $\rho$ with 75 modes and no viscosity]{\includegraphics[width=.44\textwidth]{euler1Dwall_t75_75modes_novisc.png}}
\caption{Entropy contribution of the convective term $\LRb{\bm{v}_N^T \bm{V}_h^T\LRp{\bm{Q}_h \circ \bm{F}}\bm{1}}$ over time and reduced order solution with viscosity parameter $\epsilon = 0$ at $T=.75$.  The solution does not blow up despite the presence of large oscillations resulting from the shock.}
\label{fig:novisc}
\end{figure}
...
\begin{figure}[!h]
\centering
\subfloat[Entropy over time]{\includegraphics[height=.265\textheight]{entropyevolution.png}}
\hspace{.5em}
\subfloat[Error between ROM and FOM]{\includegraphics[height=.26\textheight]{euler_error_hypred_comparison_K2500}}
%\hspace{.1em}
%\subfloat[Difference, 25 modes]{\includegraphics[width=.32\textwidth]{viscdiff25modes.png}}
