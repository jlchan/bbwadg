#ifndef _BOOKCODES_HEADER
#define _BOOKCODES_HEADER
...
MatrixXd Vandermonde1D(int N, VectorXd r); // for face
...
void GradVandermonde2D(int N, VectorXd r, VectorXd s, MatrixXd &Vr, MatrixXd &Vs); 
...
// unused routine - but can define Warp and Blend nodes using this basis
...
void meshgrid(VectorXd x, VectorXd y, MatrixXd &X, MatrixXd &Y);
void meshgrid(VectorXi x, VectorXi y, MatrixXi &X, MatrixXi &Y);
